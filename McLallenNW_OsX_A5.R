...
folder <- args
#print(folder)
inputPath <- paste(folder, "/OrganizedData.csv", sep="")
# data <- read.csv("/Users/tatemclallen/Desktop/BIOL230-info/RGUIProject/OrganizedData.csv",header=TRUE)
data <- read.csv(inputPath,header=TRUE)
...
textPath <- paste(folder, "/tTests.txt", sep="")
# sink(file = '/Users/tatemclallen/Desktop/BIOL230-info/RGUIProject/tTests.txt')
sink(file = textPath)
print(tResultsGC)
print(tResultsPur)
print(tResultsLen)
...
pdfPath <- paste(folder, "/Rplots.pdf", sep="")
# pdf(file = "/Users/tatemclallen/Desktop/BIOL230-info/RGUIproject/Rplots.pdf", width = 9, height = 6) 
pdf(file = pdfPath, width = 9, height = 6) 
